...
![Trusted Domain Warning 1](trusted_domain_1.PNG)
...
3.  Click **Add Item**.
4.  Enter `https://raw.githubusercontent.com/SirDoggyJvla/pz-translation-data`.

![Trusted Domain Settings 2](trusted_domain_2.PNG)
...
```json
{
    "json.schemaDownload.trustedDomains": [
        "https://raw.githubusercontent.com/SirDoggyJvla/pz-translation-data"
    ]
}
```
